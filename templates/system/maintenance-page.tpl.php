    ...
    <div id="content" role="article" class="column">
      ...
      <?php if ($content): ?>
        <main id="main" role="main">
          ...
          <?php
            $bug_nid = variable_get('de_contextual_help_bug_webform_nid', null);
            if ($bug_nid != null && http_response_code() == 500):
          ?>
          <p class="maintenance-report-bug"><span><?php print l("Report a Bug", "node/$bug_nid"); ?></span></p>
          <?php endif; ?>
        </main>
      <?php endif; ?>
    </div>
